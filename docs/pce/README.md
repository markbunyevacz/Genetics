...
10. **[Engineering/](Engineering/README.md)** — FR-461 ticketek, [delivery plan](Engineering/DELIVERY-PLAN.md), **[spec↔terv válasz](Engineering/VALASZ-SPEC-TERV.md)**, [P06 tábla](Engineering/SPEC-PLAN-TRACE.md), [adatfolyam/UX](Engineering/DATAFLOW-AND-UX.md). Nem spec-módosítás. Éles HIS pecsétig tilos.
